...
public class Queries {
	...
	public static final String QUERY_FOR_UPDATE_EMPLOYEE_WITH_NAMED_PARAMETER = "Update  Employee set firstName=:firstName , age=:age , lastName=:lastName , address=:address  , bloodGroup=:bloodGroup , departmentName=:departmentName , employeeType=:employeeType where id=:id";
