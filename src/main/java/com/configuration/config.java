...
public class config {
	 ...
	 * environmental values.
        ...
        properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("spring.hibernate.createTable"));
        return properties;
    }
     ...
     * session factory should be created for one database. When you have multiple
     * databases in your application you should create multiple SessionFactory
     * object. Assume the scenario that you are using one database called mysql in
     * your application then following is the way to create the SessionFactory
     * object.
     */
    @Bean
